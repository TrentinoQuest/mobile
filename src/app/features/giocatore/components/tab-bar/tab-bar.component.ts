...
import { mapOutline, bookOutline, peopleOutline, personOutline, qrCode } from 'ionicons/icons';
...
export class TabBarComponent {
  ...
  constructor() {
    addIcons({ mapOutline, bookOutline, peopleOutline, personOutline, qrCode });
  }
